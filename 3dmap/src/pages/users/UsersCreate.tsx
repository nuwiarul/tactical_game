...
const UsersCreate = () => {
    ...
    const onCreate = async () => {
        ...
        if (password !== confirmPassword) {
            toast.error("Password is not same Confirm Password");
            return;
        }
        ...
        try {
            const response = await axiosInstance.post(API_PATHS.USERS.CREATE,{
                name: name,
                username: username,
                password: password,
                role: "user",
            ...
            consoleErrorApi(error, "User Create")
        }
            ...
            <div className="p-4">
                ...
                <div className="mt-4 flex flex-col gap-2">
                    ...
                    <div className="grid w-full items-center gap-3">
                        ...
                        <Input type="text" id="confirm_password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
                    </div>
